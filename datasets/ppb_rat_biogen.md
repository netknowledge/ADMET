---
layout: default
permalink: /datasets/ppb_rat_biogen
---
...
**Dataset**: Download it [here](/ADMET/datasets/PPB_rat_Biogen.csv). 

**Dataset description:** 168 compounds with measured logarithm of the percentage **unbound** to rat plasma protein, released by Biogen. 

**Dataset preprocessing** 

- Download the original dataset from [here](https://github.com/molecularinformatics/Computational-ADME/blob/main/ADME_public_set_3521.csv), which contains 168 compounds with available measurements; 
